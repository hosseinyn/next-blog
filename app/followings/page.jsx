      ...
      {status != "loading" && status != "unauthenticated" && (
        <>
          ...
          <div className="p-4 sm:ml-64">
            <h1 className="text-3xl mt-10 mb-6 text-center">Followings</h1>
              ...
              {followings.length > 0 &&
                followings.map((following, index) => (
                  ...
                  <div key={index} className="w-full flex justify-around mt-3 ">
                    <Follow name={following.target} className="ms-3" />
                    <button onClick={() => handleUnfollow(following.target)} className="w-28 h-10 border-gray-400 border-solid border hover:bg-gray-400 duration-700 rounded-full cursor-pointer">
                      Unfollow
                    </button>
